...
predict_2017 = read.csv("Result - Final/load_record_2017.csv")
predict_2018 = read.csv("Result - Final/load_record_2018.csv")
predict_2019 = read.csv("Result - Final/load_record_2019.csv")
...
load_2019 <- xts(predict_2019$load,order.by = datetimes_2019, tz="UTC")
predseries_2019 <- xts(predict_2019$predict,order.by = datetimes_2019, tz="UTC")
